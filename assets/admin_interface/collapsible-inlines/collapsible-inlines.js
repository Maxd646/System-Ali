  ...
  (function ($) {
    $(document).ready(function () {
      function collapsibleInline(scope, collapsed) {
        ...
        var collapseToggleText = fieldsetCollapsed
          ? gettext("Show")
          : gettext("Hide");
        var collapseToggleHTML =
          ' (<a class="collapse-toggle" href="#">' +
          collapseToggleText +
          "</a>)";
      ...
      var stackedInlinesOptionSel =
        ".admin-interface.collapsible-stacked-inlines";
      var stackedInlinesSel =
        stackedInlinesOptionSel + ' .inline-group[data-inline-type="stacked"]';
      var stackedInlinesCollapsed = $(stackedInlinesOptionSel).hasClass(
        "collapsible-stacked-inlines-collapsed",
      );

      var tabularInlinesOptionSel =
        ".admin-interface.collapsible-tabular-inlines";
      var tabularInlinesSel =
        tabularInlinesOptionSel +
        ' .inline-group[data-inline-type="tabular"] .inline-related.tabular';
      var tabularInlinesCollapsed = $(stackedInlinesOptionSel).hasClass(
        "collapsible-tabular-inlines-collapsed",
      );
